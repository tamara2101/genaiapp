...
st.sidebar.markdown(f'<div class="sidebar-content">{custom_gpt}</div>', unsafe_allow_html=True)
st.sidebar.markdown('<div class="sidebar-content">Bitte eine Anfrage zu dem entsprechendem Themengebiet in das Chatfenster eingeben</div>', unsafe_allow_html=True)
st.sidebar.divider()
...
# Footer
st.markdown('<div class="main-footer">Powered by AI Tutor & OpenAI</div>', unsafe_allow_html=True)